...
$(function () {
    ...
    if ($("body#comingsoon").length) {
        ...
        img = '/img/error-php-monitoring.jpg';
        valign = 'top';
    }
    $.vegas({
        fade: 1000,
...
ga('create', 'UA-49964131-2', 'catchy.io');
...
$('#mce-EMAIL').on('change', function() {
    ga('send', 'event', 'subscribe', 'edit', 'input', (Date.now() - loadedTime));
});
...
//    script.src = 'http://downloads.mailchimp.com/js/jquery.form-n-validate.js';
    script.src = '/js/jquery.form-n-validate.min.js';
    head.appendChild(script);
...
function mce_init_form() {
    jQuery(document).ready(function ($) {
        ...
        options = { url: 'http://catchy.us8.list-manage.com/subscribe/post-json?u=7bae025693f6b8167f07d39c6&id=7b744aedb8&c=?', type: 'GET', dataType: 'json', contentType: "application/json; charset=utf-8",
...
function mce_success_cb(resp) {
    ...
    if (resp.result == "success") {
        ...
        ga('send', 'event', 'subscribe', 'failure');
        var index = -1;
        var msg;
        try {
